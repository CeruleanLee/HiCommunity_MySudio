...
//        Log.e(TAG,"时间222--->"+TimeUtil.getCountTime(Long.parseLong(mBean.getRemainTime())/ 1000));

        startCutdown(mViewHolder.mCounterTime, position,(Long.parseLong(mBean.getRemainTime())),1000);
