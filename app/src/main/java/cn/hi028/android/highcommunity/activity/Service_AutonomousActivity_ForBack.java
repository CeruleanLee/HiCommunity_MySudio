 ...
 * @时间：2016/10/9<br>
 */
public class Service_AutonomousActivity_ForBack extends BaseFragmentActivity {
	...
	private void take() {
		...
		Service_AutonomousActivity_ForBack.this.startActivityForResult(chooserIntent,
