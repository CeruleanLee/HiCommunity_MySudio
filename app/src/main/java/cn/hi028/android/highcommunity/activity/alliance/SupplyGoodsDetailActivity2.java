...
//    NoScrollListview mCommentListview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        topPage = new McoyProductDetailInfoPage(SupplyGoodsDetailActivity2.this,
                getLayoutInflater().inflate(
                        R.layout.page_top_supply, null));
        bottomPage = new McoyProductContentPage(SupplyGoodsDetailActivity2.this,
                getLayoutInflater().inflate(
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.ac_shop_car_go_pay:
                if (good_count == 0) {
                    Toast.makeText(SupplyGoodsDetailActivity2.this, "请选择商品数量", Toast.LENGTH_SHORT).show();
                    return;
                }
                upDateList();
...
//        }
    ...
    IBpiHttpHandler getOrderNo = new IBpiHttpHandler() {
        ...
        public void onSuccess(Object message) {
            ...
            Intent intent = new Intent(SupplyGoodsDetailActivity2.this,
...
//                }
    ...
    View getCommentPageView(NewSupplyGoodsDetailBean.SupplyGoodsDetailDataEntity msg) {
        ...
        if (null != msg.getComment()) {
            ...
            SupplyGoodsDetailCommentAdapter mEvaluationAdapter = new SupplyGoodsDetailCommentAdapter(mCommentList, SupplyGoodsDetailActivity2.this);
...
//            setCarAmount();
        ...
        if (msg.getRecommend() != null) {
            ...
            SupplGoodsDetailGridAdapter mAdapter = new SupplGoodsDetailGridAdapter(mRecommendList, SupplyGoodsDetailActivity2.this);
